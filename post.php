...
<div class="container">
    ...
    <div class="row">
        ...
        if (isset($_GET['p_id'])) {
            ...
            $view_query = "UPDATE post SET post_view_count = post_view_count + 1 WHERE post_id = $the_post_id ";
            $post_view_count_query = mysqli_query($conn, $view_query);
            if (!$post_view_count_query) {
